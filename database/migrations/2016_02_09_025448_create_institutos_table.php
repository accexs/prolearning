...
class CreateInstitutosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('institutos', function (Blueprint $table) {
            ...
            $table->string('location1', 150)->nullable();
            $table->string('coord1', 30)->nullable();
            ...
            $table->text('reasons_en')->nullable();
            $table->string('website', 100);
            $table->string('tel', 20);
            $table->text('campustour_es');
            $table->text('campustour_en')->nullable();
            $table->text('programs_es');
            $table->text('programs_en')->nullable();
            $table->text('accomm_es');
            $table->text('accomm_en')->nullable();
