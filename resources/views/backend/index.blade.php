...
@section('content')
<div class="container" ng-app="paisApp" ng-controller="mainController">
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="form-group error">
                                <label for="name_es" class="col-md-5 control-label">Nombre español</label>
                                <input type="text" name="name_es" value=" <% name_es %> " ng-model="paisData.name_es" required>
                                <p class="col-md-offset-3" ng-show="paisForm.name_es.$invalid" class="help-inline">Nombre es requerido.</p>
                            </div>
                            <div class="form-group error">
                                <label for="name_en" class="col-md-5 control-label">Nombre ingles</label>
                                <input type="text" name="name_en" value=" <% name_en %> " ng-model="paisData.name_en" required>
